	...
	Route::group(['middleware' => ['auth', 'verified']], function () {
		...
		Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
			...
			Route::get('dashboard/total_customer_widget', 'DashboardController@total_customer_widget')->name('dashboard.total_customer_widget');
				Route::get('dashboard/total_customers_widget', 'DashboardController@total_customers_widget')->name('dashboard.total_customers_widget');
				Route::get('dashboard/total_user_widget', 'DashboardController@total_user_widget')->name('dashboard.total_user_widget');
			...
			Route::get('expense_categories/{id}', 'ExpenseCategoryController@show')->name('expense_categories.show');
