	...
	<div class="row px-2">
	    <div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="cus_code" value="{{ old('cus_code') }}"required>
			</div>
		</div>
	    <div class="col-md-6">
			<div class="form-group">
				<label class="control-label">{{ _lang('Customer Name') }}</label>						
				<input type="text" class="form-control" name="cus_name" value="{{ old('cus_name') }}" required>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<select class="form-control auto-select select2" data-selected="{{ old('expense_category_id') }}" name="expense_category_id"  required>
					<option value="">{{ _lang('Select Server') }}</option>
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="number" class="form-control" name="no_of_users" value="{{ old('no_of_users') }}">
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				<label class="control-label">{{ _lang('Cloud Start Date') }}</label>						
				<input type="date" class="form-control" name="cloud_start_date" value="{{ old('cloud_start_date') }}">
			</div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
				...
				<div class="input-group mb-3">
					...
					<!--</div>-->
					<input type="text" class="form-control" name="amount" value="{{ old('amount') }}" aria-describedby="amount-addon">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="date" class="form-control" name="renew_date" value="{{ old('renew_date') }}">
			</div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
			    	<div class="form-group">
        				...
        				<select class="form-control auto-select" data-selected="{{ old('renewal_month') }}" name="renewal_month" >
        					...
        					<option value="Apirl">{{ _lang('April') }}</option>
			...
			<div class="form-group">
				...
				<div class="input-group mb-3">
					...
					<!--	<span class="input-group-text" id="amount-addon">{{ currency(get_base_currency()) }}</span>-->
					<!--</div>-->
					<input type="text" class="form-control" name="renew_amount" value="{{ old('renew_amount') }}" aria-describedby="amount-addon">
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<select class="form-control auto-select" data-selected="{{ old('db_cus') }}" name="db_cus" >
					<option value="">{{ _lang('Select One') }}</option>
